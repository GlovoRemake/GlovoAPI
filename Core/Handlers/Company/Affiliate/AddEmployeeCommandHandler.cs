...
public sealed class AddEmployeeCommandHandler
    : IRequestHandler<AddEmployeeCommand, Result>
{
    private readonly IAffiliateService _affiliateService;

    public AddEmployeeCommandHandler(IAffiliateService affiliateService)
    {
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            await _affiliateService.AddEmployee(request.affiliateId, request.partnerDto);
