...
namespace Domain.Migrations
{
    ...
    [Migration("20260805112845_add weight type to company product add edit types")]
    partial class addweighttypetocompanyproductaddedittypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Company.Partner.PartnerRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Company.Product.Sale.AdditionalSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Company.RequestCompany", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.Company.RequestCompany", b =>
                {
                    b.HasOne("Domain.Entities.Company.Company", "Company")
                        .WithMany("RequestCompanies")
                        .HasForeignKey("CompanyId");

                    b.HasOne("Domain.Entities.Company.Partner.PartnerUser", "Partner")
                        .WithMany("RequestCompanies")
            ...
            modelBuilder.Entity("Domain.Entities.Payment", b =>
                {
                    b.HasOne("Core.Entities.Identity.UserEntity", "Courier")
                        .WithMany("Payments")
